<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input loai_sp" onkeyup="check('.loai_sp_lb')" value="" placeholder="Nhập loại tivi">
            </div>
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input tv_ich" onkeyup="check('.tv_ich_lb')" value="" placeholder="Nhập kích cỡ màn hình">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input phan_giai" onkeyup="check('.phan_giai_lb')" value="" placeholder="Nhập độ phân giải">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input hdh" onkeyup="check('.hdh_lb')" value="" placeholder="Nhập hệ điều hành">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label tv_app_lb">Ứng dụng:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input tv_app" onkeyup="check('.tv_app_lb')" value="" placeholder="Nhập ứng dụng">
            </div>
            <div style="display: flex;">
                <i class='bx bxs-error-circle tv_app_icon' style="display: none;position: relative;top: 6px;left: 10px;color: red;font-size: 1.8rem;padding-right: 5px;"></i>
                <span class="error_tv_app error"></span>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_nghe" onkeyup="check('.cong_nghe_lb')" value="" placeholder="Nhập công nghệ hình ảnh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input tien_ich" onkeyup="check('.tien_ich_lb')" value="" placeholder="Nhập tính năng thông minh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input ket_noi" onkeyup="check('.ket_noi_lb')" value="" placeholder="Nhập kết nối">
            </div>
            <div style="display: flex;">
...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input tv_loa" onkeyup="check('.tv_loa_lb')" value="" placeholder="Nhập công nghệ loa">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_suat" onkeyup="check('.cong_suat_lb')" value="" placeholder="Nhập công suất">
            </div>
            <div style="display: flex;">
