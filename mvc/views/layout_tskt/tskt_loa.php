<div class="col-sm-6">
    <div class="form-group">
        <label for="" class="form-label loai_sp_lb">Loại sản phẩm:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input loai_sp" onkeyup="check('.loai_sp_lb')" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['loai_sp']:""; ?>" placeholder="Nhập loại sản phẩm">
            </div>
    ...
    <div class="form-group">
        <label for="" class="form-label cong_nghe_lb">Phím điều khiển:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_nghe" onkeyup="check('.cong_nghe_lb')" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['cong_nghe']:""; ?>" placeholder="Nhập phím điều khiểu">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label hdh_lb">Hệ điều hành tương thích:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input hdh" onkeyup="check('.hdh_lb')" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['he_dieu_hanh']:""; ?>" placeholder="Nhập hệ điều hành tương thích">
            </div>
            <div style="display: flex;">
