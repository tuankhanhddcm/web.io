<div class="col-sm-6">
    <div class="form-group">
        <label for="" class="form-label loai_sp_lb">Loại máy lạnh:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input loai_sp" onkeyup="check('.loai_sp_lb')" value="" placeholder="Nhập loại máy lạnh">
            </div>
    ...
    <div class="form-group">
        <label for="" class="form-label kieu_tu_lb">Kiểu máy lạnh:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input kieu_tu" onkeyup="check('.kieu_tu_lb')" value="" placeholder="Nhập kiểu máy lạnh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label dung-tich_lb">Phạm vi lạnh:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input dung-tich" onkeyup="check('.dung-tich_lb');" value="" placeholder="Nhập phạm vi lạnh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label cong_nghe_lb">Công nghệ làm lạnh:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_nghe" onkeyup="check('.cong_nghe_lb');" value="" placeholder="Nhập công nghệ làm lạnh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label chat_lieu_lb">Chất liệu dàn tản nhiệt:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input chat_lieu"  onkeyup="check('.chat_lieu_lb');" value="" placeholder="Nhập chất liệu dàn tản nhiệt">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label ket_noi_lb">Chế độ gió:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input ket_noi" onkeyup="check('.ket_noi_lb');" value="" placeholder="Nhập chế độ gió">
            </div>
            <div style="display: flex;">
...
<div class="col-sm-6">
    ...
    <div class="form-group">
        <label for="" class="form-label cn_kk_lb">Lọc bụi, kháng khuẩn, khử mùi:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cn_kk" onkeyup="check('.cn_kk_lb');" value="" placeholder="Nhập lọc bụi, kháng khuẩn, khử mùi">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label cong_suat_lb">Công suất làm lạnh, sưởi ấm:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_suat" onkeyup="check('.cong_suat_lb');" value="" placeholder="Nhập công suất làm lạnh, sưởi ấm">
            </div>
            <div style="display: flex;">
