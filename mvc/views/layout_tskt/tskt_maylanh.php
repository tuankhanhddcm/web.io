...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input loai_sp" onkeyup="check('.loai_sp_lb')" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['loai_sp']:""; ?>" placeholder="Nhập loại máy lạnh">
            </div>
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input kieu_tu" onkeyup="check('.kieu_tu_lb')" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['kieu_tu']:""; ?>" placeholder="Nhập kiểu máy lạnh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input dung-tich" onkeyup="check('.dung-tich_lb');" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['dung_tich']:""; ?>" placeholder="Nhập phạm vi lạnh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_nghe" onkeyup="check('.cong_nghe_lb');" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['cong_nghe']:""; ?>" placeholder="Nhập công nghệ làm lạnh">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input chat_lieu"  onkeyup="check('.chat_lieu_lb');" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['chat_lieu']:""; ?>" placeholder="Nhập chất liệu dàn tản nhiệt">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input ket_noi" onkeyup="check('.ket_noi_lb');" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['ket_noi']:""; ?>" placeholder="Nhập chế độ gió">
            </div>
            <div style="display: flex;">
...
<div class="col-sm-6">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cn_kk" onkeyup="check('.cn_kk_lb');" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['ung_dung']:""; ?>" placeholder="Nhập lọc bụi, kháng khuẩn, khử mùi">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_suat" onkeyup="check('.cong_suat_lb');" value="<?php echo isset($_SESSION['tskt']) ? $_SESSION['tskt']['cong_suat']:""; ?>" placeholder="Nhập công suất làm lạnh, sưởi ấm">
            </div>
            <div style="display: flex;">
