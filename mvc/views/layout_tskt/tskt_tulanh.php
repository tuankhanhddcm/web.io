<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input loai_sp"  onkeyup="check('.loai_sp_lb')" value="" placeholder="Nhập loại tủ">
            </div>
    ...
    <div class="form-group">
        <label for="" class="form-label kieu_tu_lb">Kiểu tủ:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input kieu_tu" onkeyup="check('.kieu_tu_lb')" value="" placeholder="Nhập kiểu tủ">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input so_canh" onkeyup="check('.so_canh_lb')" value="" placeholder="Nhập số cánh cửa">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input dung-tich" onkeyup="check('.dung-tich_lb')" value="" placeholder="Nhập dung tích tủ">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_nghe " onkeyup="check('.cong_nghe_lb')" value="" placeholder="Nhập công nghệ tủ">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input chat_lieu" onkeyup="check('.chat_lieu_lb')" value="" placeholder="Nhập chất liệu tủ">
            </div>
            <div style="display: flex;">
...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cn_kk" onkeyup="check('.cn_kk_lb')" value="" placeholder="Nhập công nghệ khang khuẩn, khử mùi">
            </div>
            <div style="display: flex;">
