<div class="col-sm-6">
    <div class="form-group">
        <label for="" class="form-label loai_sp_lb">Loại máy giặt:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input loai_sp" onkeyup="check('.loai_sp_lb')" value="" placeholder="Nhập loại máy giặt">
            </div>
    ...
    <div class="form-group">
        <label for="" class="form-label kieu_tu_lb">Kiểu động cơ:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input kieu_tu" onkeyup="check('.kieu_tu_lb')" value="" placeholder="Nhập kiểu động cơ">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label so_canh_lb">Lồng giặt: </label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input so_canh" onkeyup="check('.so_canh_lb')" value="" placeholder="Nhập lồng giặt">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label dung-tich_lb">Khối lượng giặt:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input dung-tich" onkeyup="check('.dung-tich_lb')" value="" placeholder="Nhập khối lượng giặt">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label cong_nghe_lb">Công nghệ giặt:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_nghe" onkeyup="check('.cong_nghe_lb')" value="" placeholder="Nhập công nghệ giặt">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label chat_lieu_lb">Chất liệu máy:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input chat_lieu" onkeyup="check('.chat_lieu_lb')" value="" placeholder="Nhập chất liệu máy">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input tien_ich" onkeyup="check('.tien_ich_lb')"  value="" placeholder="Nhập tiện ích">
            </div>
            <div style="display: flex;">
...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input ket_noi" onkeyup="check('.ket_noi_lb')" value="" placeholder="Nhập bảng điều khiển">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label cn_kk_lb">Tốc độ quay vắt tối đa:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cn_kk" onkeyup="check('.cn_kk_lb')" value="" placeholder="Nhập tốc độ quay vắt tối đa">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        <label for="" class="form-label cong_suat_lb">Hiệu suất sử dụng điện:</label>
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input cong_suat" onkeyup="check('.cong_suat_lb')" value="" placeholder="Nhập hiệu suất sử dụng điện">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input kich_thuoc" onkeyup="check('.kich_thuoc_lb')" value="" placeholder="Nhập kích thước">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input kl" onkeyup="check('.kl_lb')" value="" placeholder="Nhập khối lượng">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input noi_sx" onkeyup="check('.noi_sx_lb')" value="" placeholder="Nhập nơi sản xuất">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input bh" onkeyup="check('.bh_lb')" value="" placeholder="Nhập bảo hành">
            </div>
            <div style="display: flex;">
    ...
    <div class="form-group">
        ...
        <div class="form-wrap">
            <div class="form_input">
                <input type="text" class="form-input nam" onkeyup="check('.nam_lb')" value="" placeholder="Nhập năm ra mắt">
            </div>
            <div style="display: flex;">
