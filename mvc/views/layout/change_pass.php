<div class="user_main">
    ...
    <div class="user_main-wrap">
        <div class="form-user " style="min-height: 72px;">
            ...
            <div class="form-wrap--user">
                <div class="form_input--user">
                    <input type="text" class="input--user old_pass" onkeyup="check('.old_pass_lb')" value="" placeholder="Nhập mật khẩu cũ">
                </div>
        ...
        <div class="form-user " style="min-height: 72px;">
            ...
            <div class="form-wrap--user">
                <div class="form_input--user">
                    <input type="text" class="input--user  new_pass" onkeyup="check('.new_pass_lb')" value="" placeholder="Nhập mật khẩu mới">
                </div>
                <div style="display: flex;">
        ...
        <div class="form-user " style="min-height: 72px;">
            ...
            <div class="form-wrap--user">
                <div class="form_input--user">
                    <input type="text" class="input--user  new_pass_again" onkeyup="check('.new_pass_again_lb')" value="" placeholder="Nhập lại mật khẩu">
                </div>
                <div style="display: flex;">
        ...
        <div class="col-sm-12">
            <button class=" btn_cus btn_account">Đặt lại mật khẩu</button>
        </div>
    </div>
